...
- `DEV_ADMIN_DIAGNOSTICS_INTEGRATION_PLAN.md` — safe integration plan for read-only v5 diagnostics behind permissions, feature flags, environment gates and audit.
