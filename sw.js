const CACHE_VERSION = 'PACKIT_QUICK_TRUSS_MODAL_UI_2026_05_26';
const CACHE_NAME = 'packit-quick-truss-modal-ui-2026-05-26';
const RUNTIME_CACHE = 'packit-runtime-quick-truss-modal-ui-2026-05-26';
...
const CORE_ASSETS = [
  ...
  './src/styles/modules/configurators.css',
  './src/styles/modules/dashboard.css',
  './src/styles/modules/document-source.css',
  './src/styles/modules/documents.css',
  './src/styles/modules/equipment.css',
  './src/styles/modules/misc.css',
  './src/styles/modules/projects-warehouse.css',
  './src/styles/modules/quick.css',
  './src/styles/modules/quick-polish.css',
  './src/styles/modules/quick-controls-final.css',
  './src/styles/modules/quick-target-layout.css',
  './src/styles/modules/quick-target-workspace.css',
  './src/styles/modules/quick-target-stabilize.css',
  './src/styles/modules/quick-truss-fix-pass.css',
  './src/styles/modules/quick-truss-accordions.css',
  './src/styles/modules/quick-truss-load-modal.css',
  ...
  './src/styles/modules/reports.css',
  './src/styles/modules/site-checklist.css',
  './src/styles/modules/subrentors.css',
  './src/styles/modules/summary-kpi.css',
  './src/styles/modules/sync.css',
  './src/styles/modules/truss.css',
  './src/styles/modules/ui-final-audit.css',
  './src/styles/modules/warehouse.css',
  './src/styles/modules/wizard.css',
  './src/styles/modules/wizard-steps.css',
  './src/styles/technical/canvas.css',
  ...
  './src/modules/QuickTargetUiRuntime.js',
  './src/modules/QuickPanelScrollReset.js',
  './src/modules/QuickTrussTemplateAccordions.js',
  './src/modules/QuickTrussLoadModalPortal.js',
